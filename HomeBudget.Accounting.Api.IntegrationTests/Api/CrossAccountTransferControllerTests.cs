...
namespace HomeBudget.Accounting.Api.IntegrationTests.Api
{
    ...
    public class CrossAccountTransferControllerTests
    {
        ...
        public async Task ApplyTransfer_WithStandardFlow_ThenExpectedOperationWillBeAccomplished()
        {
            ...
            await _sut.RestHttpClient.ExecuteWithDelayAsync<Result<CrossAccountsTransferResponse>>(createRequest, executionDelayAfterInMs: 15000);
        ...
        public async Task RemoveTransfer_ThenRelatedOperationsAlsoWillBeDeleted()
        {
            ...
            var transferOperationResponse = await _sut.RestHttpClient.ExecuteWithDelayAsync<Result<CrossAccountsTransferResponse>>(createRequest, executionDelayAfterInMs: 1000);
