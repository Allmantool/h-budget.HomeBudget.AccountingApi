...
cat <<EOF >> "$CONFIG"
listeners=PLAINTEXT://0.0.0.0:29092,PLAINTEXT_HOST://0.0.0.0:29093,CONTROLLER://0.0.0.0:9093
advertised.listeners=PLAINTEXT://test-kafka:29092,PLAINTEXT_HOST://localhost:29093
